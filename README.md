...
- the arguments `username=` and `secret=` must be defined in one of the ways explained in [Setting your login credentials](https://github.com/jgte/ls5-login/blob/master/README.md#setting-your-login-credentials).
